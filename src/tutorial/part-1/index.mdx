...
1. Log into Gatsby Cloud
1. Give Gatsby Cloud access to your GitHub repo. Site will build automatically. You get a unique URL for each build. But that URL isn't human readable. It would be great to have a cleaner URL. Luckily, you can get one, with Gatsby Hosting!
