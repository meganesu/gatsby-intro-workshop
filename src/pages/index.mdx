...
<Text variant="h2" as="h2" sx={{ mt: [4, 7] }}>
  Prerequisites
</Text>

Prior to the workshop, please go through <StyledLink to="tutorial/part-0">Part 0</StyledLink> to make sure you have all the necessary tools installed.
