...
- How to use the `StaticImage` component from the `gatsby-plugin-image` plugin.
...
<H3>Adding a plugin to your site</H3>
...
<H3>
  An Example: <inlineCode>gatsby-plugin-image</inlineCode>
</H3>
...
<H4>
  Step 1: Install <inlineCode>gatsby-plugin-image</inlineCode> and dependencies
</H4>
...
<H4>
  Step 2: Configure <inlineCode>gatsby-plugin-image</inlineCode> and
  dependencies
</H4>
...
<!-- TODO: I couldnt get this to use the <H4> component without breaking MDX for whatever reason-->
...
<H2>
  Exercise #1: Add <inlineCode>gatsby-plugin-image</inlineCode>
</H2>
...
<H2>Exercise #2: Add more plugins!</H2>
...
- [`gatsby-plugin-offline`](https://www.gatsbyjs.com/plugins/gatsby-plugin-offline/): Add service worker support.
