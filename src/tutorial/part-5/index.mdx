...
* The `allMdx` and `mdx` fields (for your GraphQL queries) -- You can see these in GraphiQL
...
1. Add `gatsby-plugin-mdx` to your site.
    * You will also need to install the `@mdx-js/mdx` and `@mdx-js/react` packages.
...
But if you get stuck, here's [one possible solution](https://github.com/meganesu/gatsby-intro-workshop-example-site-with-v3/compare/part4-exercise3...part5-exercise1).
