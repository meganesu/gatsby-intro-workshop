...
const Layout = ({ children, pageContext, tutorial }) => (
  <div sx={tutorial ? {...layoutStyles, maxWidth: ['100%', '95%', '62rem']} : {...layoutStyles, maxWidth: ['100%', '48rem']}}>
    <div sx={bodyStyles}>
      <main>
    ...
    <footer sx={footerStyles}>
      ...
      />
      <Text variant="small" sx={{m:'0px', ml: 2}}>&copy; 2021 Gatsby Inc. <a href="https://www.gatsbyjs.com">Go to the GatsbyJS homepage &rarr;</a></Text>
    </footer>
  </div>
);
